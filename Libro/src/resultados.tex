...
El DE y PSO tienen otra funci\'on objetivo. La tercera comentada en \ref{sect:fobjetivo}.
...
uno y de esta forma crear pruebas mucho m\'as espec\'ificas.
...
El algoritmo funciona tal cual como se explic\'o en \ref{sect:metade}. Las cosas
diferentes es primero el cruce, que lo que se hace adicional, es que 
un punto entre $[1,M|$ haga tenga 100\% de probabilidad de cruce. La condici\'on
...
La media de \'este va a ser 0.75. \'Esto permite variaciones estoc\'asticas en el vector diferencia, y
por lo tando ayuda a mantener dibersa la poblaci\'on a medida que la b\'usqueda progresa.

\item {\bf $Cr$:} Se establece un $Cr_{max}$ y $Cr_{min}$. La idea es que vaya
decrementando linealmente desde el primero hasta el segundo. El motivo es que al comienzo
se desea que explore el espacio de b\'usqueda y al final se enfoque y mejores las soluciones
